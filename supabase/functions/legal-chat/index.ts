...
## 📐 هيكلة الجواب (التزم بها):

### ⚖️ التكييف القانوني
- تحديد الإشكال القانوني الرئيسي بدقة
- تصنيف النزاع

### 📜 السند القانوني
- القوانين المنطبقة (بأسمائها وأرقامها)
- المواد/الفصول ذات الصلة المباشرة فقط

### 🔍 الاتجاه القضائي
- القرارات المتاحة من السياق فقط (بدون اختلاق أرقام)
- إن لم تتوفر قرارات: اذكر الاتجاه العام بحذر
